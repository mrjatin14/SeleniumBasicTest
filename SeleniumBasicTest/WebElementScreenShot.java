...
public class WebElementScreenShot {
	...
	public static void main(String[] args) throws IOException {
		...
		WebElement section = driver.findElement(By.xpath("//a[@id='u_0_0_oT']"));
		//step2: call getScreenshotAs method to create img file

		File src=section.getScreenshotAs(OutputType.FILE);
		File dest = new File("C:\\Users\\Jatin\\eclipse-workspace\\SeptCucumber\\Screenshots\\webelement.png");
